...
- [절차](#절차)
  - [1. git·gh 설치 확인](#1-gitgh-설치-확인)
  - [2. GitHub 계정 연결](#2-github-계정-연결)
  - [3. Git 연결](#3-git-연결)
  - [4. private 플러그인 접근 확인](#4-private-플러그인-접근-확인)
  - [5. private 플러그인 설치](#5-private-플러그인-설치)
  - [6. 개발 런타임 셋팅 위임·완료](#6-개발-런타임-셋팅-위임완료)
- [이어받기](#이어받기-승인-후-재개)
