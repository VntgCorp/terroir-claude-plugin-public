...
- [0. 게이트 (모든 verb 공통 — 먼저)](#0-게이트-모든-verb-공통--먼저)
- [0b. setup (게이트가 NO_STORAGE일 때만)](#0b-setup-게이트가-nostorage일-때만)
- [0c. 무인 drain (추후 제공 예정 — 현재 미제공)](#0c-무인-drain-추후-제공-예정--현재-미제공)
- [1. verb 분기 (사용자 요청으로 판단)](#1-verb-분기-사용자-요청으로-판단)
- [Do NOT](#do-not)
