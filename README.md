...
|---|---|---|---|
| [`terroir-onboarding`](plugins/terroir-onboarding/CHANGELOG.md) | `1.1.0` | 조직 멤버인데 private 레포가 404일 때 SSO 재승인을 먼저 시도하고, 조직 가입 안내에 2단계 인증(2FA)을 추가 | 플러그인 업데이트 후 `/reload-plugins` |
